    ...
    <footer className="footer">
      <div className="container footer__inner">
        ...
        <div className="footer__col">
          ...
          <a href="tel:+17012609707" className="footer__link">(701) 260-9707</a>
        ...
        <div className="footer__col">
          ...
          <a href="/#services" className="footer__link">Snow removal</a>
          <a href="/#services" className="footer__link">Pressure washing</a>
          <a href="/#services" className="footer__link">Holiday lighting</a>
          <a href="/#services" className="footer__link">Fleet &amp; bin washing</a>
        </div>
      </div>
